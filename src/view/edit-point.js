...
function getTemplateOffers({offers}) {
  return (`
...
function createFormEditRouteTemplate(point, offers, destination) {
...
export default class RouteFormEditView extends AbstractView {
  #point = null;
  #offers = null;
  #destination = null;
  ...
  get template() {
    return createFormEditRouteTemplate(this.#point, this.#offers, this.#destination);
  }
